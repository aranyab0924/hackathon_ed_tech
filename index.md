...
<div class="space-y-12 py-8">
  ...
  <header class="text-center pb-12">
    <div class="mx-auto max-w-4xl bg-gradient-to-r from-indigo-700 via-slate-800 to-gray-800 rounded-3xl p-10 shadow-2xl ring-1 ring-black/10">
      ...
      <p class="mx-auto mt-6 max-w-3xl text-base sm:text-lg text-gray-300 leading-relaxed">
      ...
      <div class="mt-8 flex items-center justify-center gap-4">
        <a href="{{ '/submission' | relative_url }}" class="inline-flex items-center bg-indigo-500 text-white font-semibold py-3 px-6 rounded-full hover:bg-indigo-600 transition-shadow shadow-lg">
  ...
  <section class="grid md:grid-cols-2 gap-8">
    <div class="bg-gray-800 text-gray-200 rounded-2xl p-8 shadow-inner ring-1 ring-black/20">
  ...
  <!-- Competencies -->
  <section>
    <h2 class="text-3xl font-bold text-gray-100 mb-8 border-b border-gray-700 pb-2">Technical Competencies</h2>
    <div class="grid md:grid-cols-2 gap-8">
      <div class="bg-gray-800 rounded-2xl p-6 shadow-md ring-1 ring-black/20">
        <h3 class="text-xl font-bold text-indigo-300 mb-4">Data Science & Analytics</h3>
        <ul class="space-y-3 text-gray-300">
          <li><strong class="text-gray-100">Statistical Modeling:</strong> NumPy and Pandas for EDA and data manipulation.</li>
          <li><strong class="text-gray-100">Machine Learning:</strong> Neural networks and model training via Keras.</li>
          <li><strong class="text-gray-100">Database Management:</strong> Schema design and complex SQL querying.</li>
        </ul>
      </div>
      ...
      <div class="bg-gray-800 rounded-2xl p-6 shadow-md ring-1 ring-black/20">
        ...
        <ul class="space-y-3 text-gray-300">
          <li><strong class="text-gray-100">Modular Code:</strong> Peer reviews and clean code to minimize technical debt.</li>
          <li><strong class="text-gray-100">Cloud Architecture:</strong> Mastering AWS Cloud Essentials.</li>
          <li><strong class="text-gray-100">Full-Stack:</strong> Connecting data backends to functional interfaces.</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <section class="grid md:grid-cols-3 gap-6 text-center">
    <div class="p-6 bg-gray-800 rounded-xl shadow-sm ring-1 ring-black/15">
      <div class="text-indigo-300 font-semibold uppercase mb-2 text-sm">Documentation</div>
      <p class="text-gray-300 text-sm">System flowcharts and data-flow diagrams.</p>
    </div>
    <div class="p-6 bg-gray-800 rounded-xl shadow-sm ring-1 ring-black/15">
      <div class="text-indigo-300 font-semibold uppercase mb-2 text-sm">Demos</div>
      <p class="text-gray-300 text-sm">Presenting MVPs and Proof of Concepts.</p>
    </div>
    <div class="p-6 bg-gray-800 rounded-xl shadow-sm ring-1 ring-black/15">
      <div class="text-indigo-300 font-semibold uppercase mb-2 text-sm">Analysis</div>
      <p class="text-gray-300 text-sm">Formal post-mortem reflection and scaling.</p>
    </div>
  </section>

  <!-- Evaluation -->
  <section class="bg-indigo-900 text-white rounded-2xl p-8 shadow-xl">
  ...
  <footer class="text-center pt-8">
    <p class="text-gray-400 italic mb-6">Designed to build competitive portfolios for top-tier university programs and internships.</p>
    <a href="{{ '/submission' | relative_url }}" class="inline-block bg-indigo-500 text-white font-bold py-3 px-8 rounded-full hover:bg-indigo-600 transition shadow-lg">
